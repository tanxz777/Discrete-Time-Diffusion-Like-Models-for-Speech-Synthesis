...
./tools/F0/F0.sh "$job_name" 'model.Masking.a:0.04__model.Masking.b:0.01__model.Masking.c:0__model.Masking.d:0.0__training.learning_rate:5e-05__training.load_decoder:True__training.load_encoder:True__training.n_epochs:2400__training.start_checkpoint:1595__training.train_encoder:True'
